...
<body>
    <div class="container-fluid content-container" style="width: 100%;margin: 0;overflow: hidden;">
        ...
        <div class="col-md-10 col-lg-10 main-content">
                ...
                <div class="personal-community-box" style="width: 100%;">
                    ...
                    if (isset($_GET['search-community']) && $_GET['search-community'] != '') {
                        ...
                        $qry = "SELECT community.*,
                            ...
                            where community.`community_name` like '%$community_name%'
                                    ...
                                    <div class="community-card">
                                        ...
                                        <div class="community-details">
                                            ...
                                            <div class="community-info">
                                                ...
                                                <h4 class="users-count"><?php echo $row['total_user']; ?> Users</h4>
                                            </div>
                                        </div>
                                    </div>
                                </a>
            ...
            <div class="container top-community-tab" <?php 
            if (isset($_GET['search-community']) && $_GET['search-community'] != '') {
            ...
            ?>>
                ...
                <div class="top-community-box" style="width: 100%;display: flex;gap: 35px;">
                    <?php
                        ...
                        if (mysqli_num_rows($run) > 0) {
                            while ($row = mysqli_fetch_assoc($run)) { ?>
                                <div class="e-card communities">
                                    <img src="<?php echo $row['banner']; ?>" alt="recently-searched">
                                    <div class="author">
                                    ...
                                    <a href="./profile.php?id=<?php echo $row['owner_id']; ?>" class="title"
                                        style="text-decoration: none;color: white;">p/<?php echo $row['username']; ?></a>
                                    <div class="member"><?php echo $row['total_user']; ?> Members</div>
                                </div>
                                <?php
                            }
                        }
